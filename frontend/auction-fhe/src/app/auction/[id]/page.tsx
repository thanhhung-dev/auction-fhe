...
const auctionsData = {
  '1': {
    ...
    startingBid: '0.1',
    software: 'Maya',
    description: 'A legendary dragon NFT with unique characteristics. This rare piece features intricate details and stunning visual effects, making it a must-have for collectors.',
    mainImage: 'https://framerusercontent.com/images/lTHltm78QxmlNMOKIlALAcl5w.png',
    thumbnails: [
    ...
    auctionStartTime: Date.now() - 1 * 24 * 60 * 60 * 1000, // Started 1 day ago
    auctionEndTime: Date.now() + 2 * 24 * 60 * 60 * 1000, // Ends in 2 days
  ...
  '2': {
    ...
    startingBid: '0.05',
    software: 'Blender',
    description: 'An epic legendary sword with mystical powers. Perfect for gaming and metaverse applications.',
    mainImage: 'https://framerusercontent.com/images/sRzo2BrL41hfoV7XziSYzCY2Ks.png',
    thumbnails: [
  ...
  '3': {
    ...
    startingBid: '0.2',
    software: 'Cinema 4D',
    description: 'A collection of rare mystic gems with unique properties and stunning visuals.',
    mainImage: 'https://framerusercontent.com/images/9pTpxLi7pjrHTpZEaCBqtJIRGNk.png',
    thumbnails: [
  ...
  '4': {
    ...
    startingBid: '0.15',
    software: 'ZBrush',
    description: 'An ancient mystical relic with powerful enchantments. A true collector\'s item.',
    mainImage: 'https://framerusercontent.com/images/tMuk0nLay7UliU1ikV18AIApjiI.png',
    thumbnails: [
  ...
  '5': {
    ...
    startingBid: '0.08',
    software: 'Maya',
    description: 'A powerful cosmic warrior from the outer realms. Battle-tested and legendary.',
    mainImage: 'https://framerusercontent.com/images/JQLxkAHxmY7CXzHpcG56gjk7A.png',
    thumbnails: [
  ...
  '6': {
    ...
    startingBid: '0.12',
    software: 'Blender',
    description: 'A fearsome shadow beast from the dark dimension. Rare and powerful.',
    mainImage: 'https://framerusercontent.com/images/wlcclkL11Fiv9kpHIM3zW38lArI.png',
    thumbnails: [
