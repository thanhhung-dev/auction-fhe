...
import { RecrCustomStylish } from "@/types/customStylish";

export const generateCustomStylish: GetCustomStylish<RecrCustomStylish> = ({
  css,
  token,
  isDarkMode,
}) => {
  ...
  return {
    ...
    `,
    shadow: css`
      box-shadow: 0 1px 0 -1px ${isDarkMode ? token.colorBgLayout : token.colorBorder},
